...
function Services() {
  return (
    <section className="w-full h-[100vh] bg-white flex flex-col items-start justify-start px-[12%] box-border pt-[4%]">
      ...
      <div className="grid grid-cols-3 w-full h-[80%] gap-x-[30px] gap-y-[40px] place-items-center ">
